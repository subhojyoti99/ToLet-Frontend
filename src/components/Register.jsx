              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <select
                    ...
                    onChange={(e) => handleChange(e)}
                    id="underline_select"
                    class="w-full h-10  rounded-lg px-3 mb-4 text-gray-500 border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                  >
                  ...
                  <select
                    name="Role"
                    id="role"
                    className="w-full h-10 border border-gray-300 rounded-lg px-3 mb-4 tex-gray-100"
                    value={user.Role}
                    onChange={(e) => handleChange(e)}
                    required
                  >
                  ...
                  {user.Role === "owner" || user.Role === "admin" ? (
                    <>
                      <input
                        type="text"
                        name="valid_key"
                        placeholder="Valid key"
                        value={user.valid_key}
                        onChange={(e) =>
                          setUser({ ...user, valid_key: e.target.value })
                        }
                        required
                      />
                    </>
